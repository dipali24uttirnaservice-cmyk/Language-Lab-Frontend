    ...
    <footer className="relative border-t border-slate-200 bg-slate-50 overflow-hidden text-slate-900 selection:bg-amber-200 selection:text-amber-900">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 pt-24 pb-12">
        ...
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4 items-stretch pb-16">
          ...
          >
            <div>
              ...
              <p className="mt-3 text-xs font-semibold text-slate-500 leading-relaxed">
                An advanced, interactive language architecture built natively on
                generative artificial intelligence frameworks.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-3.5">
              <Link
                href="/"
                className="block text-xs font-bold text-slate-600 hover:text-amber-600 transition-colors"
              >
                Features Overview
              </Link>
              <Link
              ...
              {[
                {
                  ...
                  url: "#",
                  color:
                    "text-white bg-[#1877F2] border-[#1877F2] shadow-[0_4px_12px_rgba(24,119,242,0.25)] hover:scale-110",
                },
                {
                  icon: <FaTwitter />,
                  url: "#",
                  color:
                    "text-white bg-[#1DA1F2] border-[#1DA1F2] shadow-[0_4px_12px_rgba(29,161,242,0.25)] hover:scale-110",
                },
                {
                  icon: <FaInstagram />,
                  url: "#",
                  color:
                    "text-white bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] border-[#ee2a7b] shadow-[0_4px_12px_rgba(238,42,123,0.25)] hover:scale-110",
                },
                {
                  icon: <FaLinkedinIn />,
                  url: "#",
                  color:
                    "text-white bg-[#0077B5] border-[#0077B5] shadow-[0_4px_12px_rgba(0,119,181,0.25)] hover:scale-110",
                },
              ].map((social, index) => (
                <motion.a
                  key={index}
        ...
        <div className="border-t border-slate-200/80 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-bold text-slate-400 tracking-widest uppercase">
          <div>© 2026 Uttirna DigiLabs. All rights reserved.</div>
