...
export default function LearningJourneyPage() {
    ...
    const gradients = [
        { from: "from-blue-500", to: "to-indigo-600", shadow: "rgba(59,130,246,0.2)" },
        { from: "from-orange-500", to: "to-amber-500", shadow: "rgba(249,115,22,0.2)" },
        { from: "from-emerald-500", to: "to-teal-600", shadow: "rgba(16,185,129,0.2)" },
        { from: "from-purple-500", to: "to-violet-600", shadow: "rgba(139,92,246,0.2)" },
        { from: "from-pink-500", to: "to-rose-600", shadow: "rgba(236,72,153,0.2)" },
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 py-10 space-y-10">
                ...
                {courses.length === 0 ? (
                    <div className="text-center py-24 bg-white/40 rounded-3xl border border-dashed border-slate-300">
                        ...
                        <p className="text-slate-500 font-semibold">No courses assigned yet.</p>
                        <p className="text-slate-400 text-sm mt-1">Please contact your institute.</p>
                    </div>
                ) : (
                    <motion.div
                        initial="hidden"
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex items-start justify-between">
                                        ...
                                        <span className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-[11px] font-bold bg-gradient-to-br ${g.from} ${g.to} text-white shadow-sm`}>
                                            Enrolled
                                        </span>
                                    </div>
                                    ...
                                    <div className="mt-5">
                                        ...
                                        <div className="mt-3 flex flex-wrap gap-1.5">
                                            {["video", "audio", "text", "exercise"].map((t) => {
                                                const icons = { video: Play, audio: Headphones, text: FileText, exercise: Award };
                                                const Icon = icons[t];
                                                return (
                                                    <span
                                                        key={t}
