    ...
    <div className="relative min-h-screen p-6 md:p-8 space-y-6 font-sans">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-200/80 shadow-sm">
        ...
        <motion.button
          ...
          disabled={exporting}
          className="px-4 py-2.5 rounded-xl text-sm font-bold transition-all shadow-sm flex items-center gap-2 bg-slate-900 text-white hover:bg-slate-800 disabled:opacity-60"
        >
      ...
      <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm flex flex-wrap items-center gap-3">
        <div className="relative flex-1 min-w-[200px]">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm font-medium focus:outline-none focus:ring-2 focus:ring-sky-500/20 focus:border-sky-500 transition-all"
          />
        </div>
        ...
        <select
          ...
          className="px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm font-medium focus:outline-none focus:ring-2 focus:ring-sky-500/20"
        >
              ...
              <tbody className="divide-y divide-slate-100 text-sm font-medium">
                {paginatedRows.length > 0 ? (
                  paginatedRows.map((row) => (
                    <tr key={row.student_id} className="hover:bg-slate-50/65 transition-colors">
